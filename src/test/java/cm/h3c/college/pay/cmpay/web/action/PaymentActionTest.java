...
import cm.h3c.college.pay.cmpay.CmpayObjectFactory4Test;
import cm.h3c.college.pay.cmpay.CmpayPaymentCallbackRequest;

@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {"classpath:/config/spring.xml",   "classpath:/config/spring-webmvc.xml"})
public class PaymentActionTest {
	...
	public void postWebCallback() throws ClientProtocolException, IOException {
		...
		callbackRequest.setOrderId("1");
		String xml = new CmpayObjectFactory4Test()
        ...
        try {
            mv = handlerAdapter.handle(request, response, cmpayCallbackController);
        } catch (Exception e) {
            e.printStackTrace();
        }
