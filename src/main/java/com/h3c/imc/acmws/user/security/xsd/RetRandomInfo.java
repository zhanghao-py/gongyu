...
/**
 * <p>RetRandomInfo complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="RetRandomInfo">
 *   &lt;complexContent>
...
@XmlType(name = "RetRandomInfo", propOrder = {
    "random"
})
public class RetRandomInfo
    extends WSCommonResult
{

    @XmlElementRef(name = "random", namespace = "http://security.user.acmws.imc.h3c.com/xsd", type = JAXBElement.class)
