...
public class Login {
    ...
    @XmlElementRef(name = "param0", namespace = "http://imc.h3c.com/imcplatService", type = JAXBElement.class)
    protected JAXBElement<String> param0;
    @XmlElementRef(name = "param1", namespace = "http://imc.h3c.com/imcplatService", type = JAXBElement.class)
